...
/// Builds the standard main menu (App + Edit + Window) for Voxa.
...
enum MainMenuBuilder {
    static func install() {
        ...
        let appMenu = NSMenu(title: "Voxa")
        appMenu.addItem(NSMenuItem(title: "About Voxa", action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: ""))
        ...
        appMenu.addItem(.separator())
        appMenu.addItem(NSMenuItem(title: "Hide Voxa", action: #selector(NSApplication.hide(_:)), keyEquivalent: "h"))
        let hideOthers = NSMenuItem(title: "Hide Others", action: #selector(NSApplication.hideOtherApplications(_:)), keyEquivalent: "h")
        hideOthers.keyEquivalentModifierMask = [.command, .option]
        appMenu.addItem(hideOthers)
        appMenu.addItem(NSMenuItem(title: "Show All", action: #selector(NSApplication.unhideAllApplications(_:)), keyEquivalent: ""))
        appMenu.addItem(.separator())
        appMenu.addItem(NSMenuItem(title: "Quit Voxa", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
